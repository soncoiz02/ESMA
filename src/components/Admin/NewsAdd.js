            ...
            <form action="#" method="POST">
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="col-span-3 sm:col-span-2">
                        ...
                        <input type="text" name="company-website" id="company-website" class="focus:ring-indigo-500 outline-none focus:border-indigo-500 flex-1 block w-full py-3 px-3 rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="News title">
                        </div>
                    </div>
                    </div>
                    <div>
